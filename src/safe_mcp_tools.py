...
from .mcp_output_utils import log_large_content_warning, safe_mcp_output
...
class SafeMCPWrapper:
    ...
    def execute_safely(  # pylint: disable=line-too-long
        self, tool_func: Callable[..., Any], *args: Any, **kwargs: Any
    ) -> Any:
        """
